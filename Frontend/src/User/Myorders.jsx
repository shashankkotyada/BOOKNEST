...
function Myorders() {
  ...
  const calculateStatus = (bookingDate) => {
    ...
    // Set delivery date to one week after booking date
    const deliveryDate = new Date(formattedBookingDate);
    deliveryDate.setDate(deliveryDate.getDate() + 8); // Add 7 days
